...
function renderAboutVeiw() {
    ...
    <a href="./img/Mahanandan Tyagi orginal.jpg" class="d-flex justify-content-center"><img src="./img/Mahanandan Tyagi.jpg" class="rounded-circle" alt="Nandan's profile picture" title="Nandan Tyagi" width="10%" /></a>
                ...
                <p class="text-center">In the past I have been a semiprofessional tennis player. I was ranked 6th in India and I beat the 3rd ranked player in Sweden, as a junior. I am also a tennis coach. For the past decade I have been working as a manager in the retail bussiness. Now I am changing my career to software development and I am studying Webdevelopment.NET. My goal is to work in the webdevelopment industry by 2022.</p>
    `;
